...
class RefreshPagingStatePage<T extends BaseRefreshController> extends StatelessWidget {
    ...
    return CustomHeader(builder: (context, refreshStatus) {
      ...
      if (refreshStatus == RefreshStatus.idle) {
        ...
        customHeader = refreshStatusWidget(
          context: context,
          constant: Keys.pullToRefresh.tr,
        ...
        customHeader = refreshStatusWidget(
          context: context,
          constant: Keys.refreshSuccess.tr,
          iconData: Icons.done,
        );
      } else {
        // 松手开始刷新数据
        customHeader = refreshStatusWidget(
          context: context,
          constant: Keys.releaseStartRefreshing.tr,
    ...
    return CustomFooter(builder: (context, loadStatus) {
      ...
      if (loadStatus == LoadStatus.idle) {
        ...
        customFooter = refreshStatusWidget(
          context: context,
          constant: Keys.pullToLoading.tr,
        ...
        customFooter = refreshStatusWidget(
          context: context,
          constant: Keys.releaseStartLoading.tr,
