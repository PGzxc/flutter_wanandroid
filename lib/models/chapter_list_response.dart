...
@JsonSerializable()
class ChapterListResponse extends Object {
  ...
  ChapterListResponse(this.data,this.errorCode,this.errorMsg,);

  factory ChapterListResponse.fromJson(Map<String, dynamic> srcJson) => _$ChapterListResponseFromJson(srcJson);
