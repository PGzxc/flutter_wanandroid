...
part of 'chapter_sublist_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ChapterSubListResponse _$ChapterSubListResponseFromJson(
        Map<String, dynamic> json) =>
    ChapterSubListResponse(
      Data.fromJson(json['data'] as Map<String, dynamic>),
      json['errorCode'] as int,
      json['errorMsg'] as String,
    );

Map<String, dynamic> _$ChapterSubListResponseToJson(
        ChapterSubListResponse instance) =>
    <String, dynamic>{
      'data': instance.data,
