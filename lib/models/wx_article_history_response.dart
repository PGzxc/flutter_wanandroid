...
class WXArticleHistoryResponse extends Object {
  ...
  WXArticleHistoryResponse(this.data,this.errorCode,this.errorMsg,);

  factory WXArticleHistoryResponse.fromJson(Map<String, dynamic> srcJson) => _$WXArticleHistoryResponseFromJson(srcJson);
