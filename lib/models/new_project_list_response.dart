...
part 'new_project_list_response.g.dart';


@JsonSerializable()
class NewProjectListResponse extends Object {
  ...
  NewProjectListResponse(this.data,this.errorCode,this.errorMsg,);

  factory NewProjectListResponse.fromJson(Map<String, dynamic> srcJson) => _$NewProjectListResponseFromJson(srcJson);

  Map<String, dynamic> toJson() => _$NewProjectListResponseToJson(this);
