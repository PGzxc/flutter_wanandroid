...
part of 'wx_article_search_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

WXArticleSearchResponse _$WXArticleSearchResponseFromJson(
        Map<String, dynamic> json) =>
    WXArticleSearchResponse(
      Data.fromJson(json['data'] as Map<String, dynamic>),
      json['errorCode'] as int,
      json['errorMsg'] as String,
    );

Map<String, dynamic> _$WXArticleSearchResponseToJson(
        WXArticleSearchResponse instance) =>
    <String, dynamic>{
      'data': instance.data,
