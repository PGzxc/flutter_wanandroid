...
part 'square_list_response.g.dart';

///10广场-10.1 广场列表数据

@JsonSerializable()
class SquareListResponse extends Object {
  ...
  SquareListResponse(this.data,this.errorCode,this.errorMsg,);

  factory SquareListResponse.fromJson(Map<String, dynamic> srcJson) => _$SquareListResponseFromJson(srcJson);

  Map<String, dynamic> toJson() => _$SquareListResponseToJson(this);
