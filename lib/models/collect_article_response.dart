...
part 'collect_article_response.g.dart';

///6 收藏-6.1 收藏文章列表
@JsonSerializable()
class CollectArticleResponse extends Object {
  ...
  CollectArticleResponse(this.data,this.errorCode,this.errorMsg,);

  factory CollectArticleResponse.fromJson(Map<String, dynamic> srcJson) => _$CollectArticleResponseFromJson(srcJson);

  Map<String, dynamic> toJson() => _$CollectArticleResponseToJson(this);
