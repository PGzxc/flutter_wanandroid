...
part 'wenda_list_response.g.dart';


@JsonSerializable()
class WenDaListResponse extends Object {
  ...
  WenDaListResponse(this.data,this.errorCode,this.errorMsg,);

  factory WenDaListResponse.fromJson(Map<String, dynamic> srcJson) => _$WenDaListResponseFromJson(srcJson);

  Map<String, dynamic> toJson() => _$WenDaListResponseToJson(this);
