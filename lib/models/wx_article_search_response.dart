...
part 'wx_article_search_response.g.dart';


///15.公众号Tab-15.3 在某个公众号中搜索历史文章

@JsonSerializable()
class WXArticleSearchResponse extends Object {
  ...
  WXArticleSearchResponse(this.data,this.errorCode,this.errorMsg,);

  factory WXArticleSearchResponse.fromJson(Map<String, dynamic> srcJson) => _$WXArticleSearchResponseFromJson(srcJson);

  Map<String, dynamic> toJson() => _$WXArticleSearchResponseToJson(this);
