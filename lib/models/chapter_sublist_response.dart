...
part 'chapter_sublist_response.g.dart';

///18.教程-18.2 单个教程下所有文章列表

@JsonSerializable()
class ChapterSubListResponse extends Object {
  ...
  ChapterSubListResponse(this.data,this.errorCode,this.errorMsg,);

  factory ChapterSubListResponse.fromJson(Map<String, dynamic> srcJson) => _$ChapterSubListResponseFromJson(srcJson);

  Map<String, dynamic> toJson() => _$ChapterSubListResponseToJson(this);
