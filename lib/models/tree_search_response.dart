...
part 'tree_search_response.g.dart';

///2-2.3 按照作者昵称搜索文章

@JsonSerializable()
class TreeSearchResponse extends Object {
  ...
  TreeSearchResponse(this.data,this.errorCode,this.errorMsg,);

  factory TreeSearchResponse.fromJson(Map<String, dynamic> srcJson) => _$TreeSearchResponseFromJson(srcJson);

  Map<String, dynamic> toJson() => _$TreeSearchResponseToJson(this);
