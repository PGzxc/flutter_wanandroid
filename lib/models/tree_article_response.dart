...
part 'tree_article_response.g.dart';

///2-2.2 知识体系下的文章
@JsonSerializable()
class TreeArticleResponse extends Object {
  ...
  TreeArticleResponse(this.data,this.errorCode,this.errorMsg,);

  factory TreeArticleResponse.fromJson(Map<String, dynamic> srcJson) => _$TreeArticleResponseFromJson(srcJson);

  Map<String, dynamic> toJson() => _$TreeArticleResponseToJson(this);
