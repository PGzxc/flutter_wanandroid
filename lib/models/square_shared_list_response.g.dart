...
part of 'square_shared_list_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

SquareSharedListResponse _$SquareSharedListResponseFromJson(
        Map<String, dynamic> json) =>
    SquareSharedListResponse(
      Data.fromJson(json['data'] as Map<String, dynamic>),
      json['errorCode'] as int,
      json['errorMsg'] as String,
    );

Map<String, dynamic> _$SquareSharedListResponseToJson(
        SquareSharedListResponse instance) =>
    <String, dynamic>{
      'data': instance.data,
