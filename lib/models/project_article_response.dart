...
class ProjectArticleResponse extends Object {
  ...
  ProjectArticleResponse(this.data,this.errorCode,this.errorMsg,);

  factory ProjectArticleResponse.fromJson(Map<String, dynamic> srcJson) => _$ProjectArticleResponseFromJson(srcJson);
